// Upgrade NOTE: upgraded instancing buffer 'TeresinaFog' to new syntax.
...
Shader "Teresina/Fog"
{
	...
	SubShader
	{
		...
		UNITY_INSTANCING_BUFFER_START(TeresinaFog)
			UNITY_DEFINE_INSTANCED_PROP(float, _Intensity)
#define _Intensity_arr TeresinaFog
		UNITY_INSTANCING_BUFFER_END(TeresinaFog)
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float dotResult20 = dot( i.viewDir , float3(0,1,0) );
			float lerpResult22 = lerp( 0.0 , _Intensity_Instance , abs( dotResult20 ));
			o.Alpha = ( abs( ( eyeDepth3 - ase_screenPos.w ) ) * lerpResult22 );
		}
...
/*ASEBEGIN
Version=16200
216;73;1425;506;2085.789;616.77;2.566654;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;8;-80.32639,210.4128;Float;False;Property;_MaxIntensity;MaxIntensity;1;0;Create;True;0;0;False;0;0.6588235;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.ClampOpNode;7;155.4903,135.0699;Float;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;12;125.0067,165.5331;Float;False;Constant;_Float0;Float 0;2;0;Create;True;0;0;False;0;0.5;0;0;0;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=ACBA3C334A2A9A1F75BFC0929E373344A45D7F37